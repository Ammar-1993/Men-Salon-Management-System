...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblappointment set Remark='$remark',Status='$status' where ID='$cid'");
    ...
    echo '<script>alert("تم تحديث جميع الملاحظات")</script>';
  }
  else
    {
...
<html lang="ar">
<head>
<title>نظام إدارة صالون الرجال || عرض الموعد</title>
...
<tr>
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
     <option value="1" selected="true">محدد</option>
     <option value="2">مرفوض</option>
   </select></td>
  </tr>

  <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn-az-primary pd-x-20">إرسال</button></td>
  </tr>
  </form>
<?php } else { ?>
						</table>
