...
$pagedes=$_POST['pagedes'];
    ...
    echo '<script>alert("تم تحديث معلومات عنا")</script>';
  }
  else
    {
...
<html lang="ar">
<head>
<title>نظام إدارة صالون الرجال || معلومات عنا</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">تحديث معلومات عنا</h3>
