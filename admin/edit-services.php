...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    echo '<script>alert("تم تحديث الخدمة")</script>';
  }
  else
    {
...
<html lang="ar">
<head>
<title>نظام إدارة صالون الرجال || تحديث الخدمات</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">تحديث الخدمات</h3>
