...
$query=mysqli_query($con,"delete from tblservices where ID='$id'");
    if ($query) {
     echo "<script>alert('الخدمة محذوفة.');</script>";
...
<html lang="ar">
<head>
<title>نظام إدارة صالون الرجال || إدارة الخدمات</title>
...
<body class="cbp-spmenu-push" dir="rtl">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1"> إدارة الخدمات</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>تحديث الخدمات:</h4>
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>اسم الخدمة</th> <th>سعر الخدمة</th> <th>تاريخ الإنشاء</th><th>حدث</th> </tr> </thead> <tbody>
<?php
